        ...
        setContent {
            MyPlantDiaryTheme {
                ...
                Surface(
                    ...
                    // see what happens when you comment out the line below
                    modifier = Modifier.fillMaxSize()
                    // fillMaxSize occupies the whole of phone screen
                    // otherwise the surface is as big as needed
                ) {
                    SpecimenFacts()
                }
            }
...
fun SpecimenFacts() {
    ...
    Column {
        ...
        // see what happens when you comment out the line above
        )
        OutlinedTextField(
            value = location,
